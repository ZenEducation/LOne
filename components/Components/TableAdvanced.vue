                ...
                <table class="w-full text-left" id="table-collapse">
                  ...
                  <tbody class="ac [&.is-active_.ac-icon]:rotate-180">
                    <tr class="border-y border-transparent">
                      ...
                      <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                        <button
                          class="ac-trigger btn h-8 w-8 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25"
                        >
                          <i
