        ...
        <div class="grid grid-cols-1 gap-4 sm:gap-5 lg:gap-6">
          ...
          <div class="card px-4 pb-4 sm:px-5">
            ...
            <div class="max-w-xl">
              ...
              <div id="accordion_exapmple_1" class="mt-5 flex flex-col">
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <button
                      class="ac-trigger btn -mr-1.5 h-8 w-8 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25"
                    >
                      <i
