  ...
  >
    ...
    <div
      class="
        ...
        grid-cols-1
        gap-4
        divide-y divide-slate-150
        bg-white
        shadow-soft
        dark:divide-navy-500 dark:bg-navy-700 dark:shadow-none
        sm:grid-cols-3 sm:gap-5 sm:divide-x sm:divide-y-0
        lg:gap-6
      "
    >
      <div class="p-4 text-center sm:p-5">
        ...
        <div class="mt-5">
          <span
            class="text-4xl tracking-tight text-primary dark:text-accent-light"
            >$5</span
          >/month
        </div>
      ...
      <div class="relative p-4 text-center sm:p-5">
        ...
        <div class="mt-8">
          <i
            class="fa fa-plane text-6xl text-primary dark:text-accent-light"
          ></i>
        </div>
        <div class="mt-5">
          <h4 class="text-xl font-semibold text-slate-600 dark:text-navy-100">
      ...
      <div class="p-4 text-center sm:p-5">
        <div class="mt-8">
          <i
            class="fa fa-rocket text-6xl text-primary dark:text-accent-light"
          ></i>
        </div>
        <div class="mt-5">
          <h4 class="text-xl font-semibold text-slate-600 dark:text-navy-100">
