      ...
      <div class="col-span-12 pt-6 lg:col-span-8 lg:pb-6">
        <div class="card p-4 lg:p-6">
          ...
          <div>
            <div class="flex items-center justify-between">
              <div class="flex items-center space-x-3">
                <div id="popover-profile" class="flex">
                  <div class="avatar popper-ref h-12 w-12">
                    <img
              ...
              <div class="flex space-x-3">
                <div class="hidden sm:flex">
                  <button
                    class="
                      ...
                      active:bg-slate-300/25
                      dark:hover:bg-navy-300/20
                      dark:focus:bg-navy-300/20
                ...
                <div id="blogActions" class="inline-flex">
                  <button
                    class="
                      popper-ref
                      btn
                        ...
                        <li>
                          <a
                            ...
                            class="
                              ...
                              dark:hover:text-navy-100
                              dark:focus:bg-navy-600
                              dark:focus:text-navy-100
                            "
                            >Action</a
                          >
                        </li>
          ...
          >
            ...
            <h3 class="mt-1">
              Spurred on by my observations at work, I have come up with a list
              of things to avoid as a doctor in a hospital setting (especially
            ...
            <br />
            <p>
              Major changes have recently occured in my life, both personally
              and professionally. We're approaching five years since the
              inception of this blog, and going back to read the posts from May
              '04 is quite the experience. I suppose its what diaries and
              journals are for, the chance to go back and read out your thoughts
              and ideas from another time. Kind of like mental time travel.
            </p>
            <br />
            <p>
              One thing is for sure, I am not who I was then. In fact, I am not
              who I was last year or the year before that. I may have some (we
              shed and create a lot of cells frequently) of the bodily
              composition of that person but we are definitely on different
              wavelengths.
            </p>
            <br />
            <p>
              This whole blogging business started off as a documentation of odd
              and quirky ideas I might have. I had a lot of time on my hands
              back then, hence the frequency of the posts. With time, the posts
              have decreased in number but have also slightly sharpened in
              focus. They may still be random and don't generally adhere to one
              unified theme, but this thing was meant to be disjointed and
              arbitrary anyway.
            </p>
            <br />
            <div class="border-l-4 border-slate-300 pl-4 dark:border-navy-400">
              <p class="font-medium italic text-slate-800 dark:text-navy-100">
                ...
                How do I disable this? What do you mean I lose all the other
                base styles too?
              </p>
            </div>
            <br />
          ...
          <div class="flex items-center justify-between">
            ...
            <a
              ...
              class="
                ...
                focus:text-primary/70
                dark:text-accent-light
                dark:hover:text-accent-light/70
                dark:focus:text-accent-light/70
              "
              >View All</a
            >
          </div>
              ...
              <div class="flex w-full grow flex-col px-4 py-3 sm:px-5">
                <div class="flex items-center justify-between">
                  ...
                  <div class="-mr-1.5 flex space-x-1">
                    ...
                    <div id="cardMenu1" class="inline-flex">
                      <button
                        class="
                          popper-ref
                          btn
                ...
                <div class="mt-1 flex justify-end">
                  <a
                    ...
                    class="
                      ...
                      dark:text-accent-light
                      dark:hover:bg-accent-light/20
                      dark:focus:bg-accent-light/20
                      dark:active:bg-accent-light/25
                    "
                  >
                    READ ARTICLE
                  </a>
              ...
              <div class="flex w-full grow flex-col px-4 py-3 sm:px-5">
                <div class="flex items-center justify-between">
                  ...
                  <div class="-mr-1.5 flex space-x-1">
                    ...
                    <div id="cardMenu2" class="inline-flex">
                      <button
                        class="
                          popper-ref
                          btn
              ...
              <div class="flex w-full grow flex-col px-4 py-3 sm:px-5">
                <div class="flex items-center justify-between">
                  ...
                  <div class="-mr-1.5 flex space-x-1">
                    ...
                    <div id="cardMenu3" class="inline-flex">
                      <button
                        class="
                          popper-ref
                          btn
              ...
              <div class="flex w-full grow flex-col px-4 py-3 sm:px-5">
                <div class="flex items-center justify-between">
                  ...
                  <div class="-mr-1.5 flex space-x-1">
                    ...
                    <div id="cardMenu4" class="inline-flex">
                      <button
                        class="
                          popper-ref
                          btn
      ...
      >
        <div class="card">
          ...
          <div class="px-4 pt-2 pb-5 sm:px-5">
            ...
            <p class="mt-3">
              Professional product designer and amateur cyclist living in New
              York City, USA.
            </p>
        ...
        <div class="mt-5">
          <p
            class="
              ...
              dark:border-navy-600 dark:text-navy-100
            "
          >
                  ...
                  >
                    <a
                      ...
                      class="
                        ...
                        dark:focus:text-accent-light
                      "
                      >25 Surprising Facts About Chair</a
                    >
                  </div>
                </div>
                <div class="flex items-center justify-between">
                  <p class="text-xs font-medium line-clamp-1">14 min read</p>
