  ...
  >
    ...
    >
      <div class="rounded-xl bg-gradient-to-br from-pink-500 to-rose-500 p-1">
        <div
          class="rounded-xl bg-slate-50 p-4 text-center dark:bg-navy-900 sm:p-5"
        >
          <div class="mt-8">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              class="inline h-16 w-16 text-secondary dark:text-secondary-light"
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
            >
      ...
      <div
        class="rounded-xl bg-gradient-to-br from-purple-500 to-indigo-600 p-1"
      >
        <div
          class="
            relative
        ...
        >
          ...
          <div class="mt-8">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              class="inline h-16 w-16 text-primary dark:text-accent-light"
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
            >
      ...
      <div
        class="rounded-xl bg-gradient-to-br from-amber-400 to-orange-600 p-1"
      >
        <div
          class="rounded-xl bg-slate-50 p-4 text-center dark:bg-navy-900 sm:p-5"
        >
          <div class="mt-8">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              class="inline h-16 w-16 text-warning"
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
            >
