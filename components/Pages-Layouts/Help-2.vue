  ...
  <div class="main-content w-full px-[var(--margin-x)] pb-8">
        <div class="flex items-center justify-between space-x-6 py-5 lg:py-6">
          <div class="flex items-center space-x-4">
            ...
            <div
              class="my-1 hidden w-px self-stretch bg-slate-300 dark:bg-navy-600 sm:flex"
            ></div>
        ...
        >
          <a
            href="#"
            class="card items-center space-y-2 bg-primary py-10 px-4 text-center dark:bg-accent"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <a
            href="#"
            class="card items-center space-y-2 py-10 px-4 text-center"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              class="h-12 w-12 text-primary dark:text-accent-light"
              viewBox="0 0 24 24"
              stroke="currentColor"
              fill="none"
            >
        ...
        <div
          class="mt-4 grid grid-cols-1 gap-4 sm:mt-5 sm:gap-5 lg:mt-6 lg:grid-cols-2 lg:gap-6"
        >
