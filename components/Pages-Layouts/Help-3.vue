      ...
      <div class="space-y-20">
        <div class="grid grid-cols-1 place-items-center gap-10 lg:grid-cols-2">
          <div class="flex justify-center">
            <img
              ...
              src="images/illustrations/rocket.svg"
              alt="image"
            />
          </div>
          <div class="w-full">
        ...
        <div class="grid grid-cols-1 place-items-center gap-10 lg:grid-cols-2">
          <div class="flex justify-center lg:order-last">
            <img
              class="w-full max-w-xs"
              src="images/illustrations/mobile-app.svg"
              alt="image"
            />
          </div>
          <div class="w-full">
        ...
        <div class="grid grid-cols-1 place-items-center gap-10 lg:grid-cols-2">
          <div class="flex justify-center">
            <img
              class="w-full max-w-xs"
              src="images/illustrations/credit-card.svg"
              alt="image"
            />
          </div>
          <div class="w-full">
                ...
                <div class="ac-panel">
                  <div class="px-4 py-4 sm:px-5">
                    ...
                    <div class="mt-2 flex space-x-2">
                      <a
                        href="#"
                        class="tag rounded-full border border-info text-info"
                      >
                        Tag 1
                      </a>
                      <a
