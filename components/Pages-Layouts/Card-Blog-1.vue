              ...
              <div class="flex items-center justify-between">
                ...
                <div class="-mr-1.5 flex space-x-1">
                  ...
                  <div id="cardMenu1" class="inline-flex">
                    <button
                      class="popper-ref btn h-7 w-7 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        class="h-4.5 w-4.5"
