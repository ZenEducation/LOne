        ...
        >
          <div class="card">
            <div class="flex items-center justify-between p-4">
              <div class="flex items-center space-x-3">
                <div id="userInfo1" class="flex">
                  <div class="popper-ref avatar h-9 w-9">
                    <img
                      class="rounded-full"
              ...
              <div id="cardMenu6" class="inline-flex">
                <button
            ...
            >
              <div class="relative flex w-full">
                ...
                <div
                  class="absolute right-0 z-10 flex h-8 w-8 items-center justify-center"
                >
                  <button
          ...
          <div class="card">
            ...
            <div class="grow px-4 pt-4">
              <a
                href="#"
                class="text-base font-medium text-slate-700 hover:text-primary focus:text-primary dark:text-navy-100 dark:hover:text-accent-light dark:focus:text-accent-light"
                >The 12 Worst Types Business Accounts You Follow on Twitter</a
              >
              <p class="mt-2 line-clamp-3">
          ...
          <div class="card">
            ...
            <div class="grow px-4 pt-4">
              <a
                href="#"
                class="text-base font-medium text-slate-700 hover:text-primary focus:text-primary dark:text-navy-100 dark:hover:text-accent-light dark:focus:text-accent-light"
                >10 Meetups About Food You Should Attend</a
              >
              <p class="mt-2 line-clamp-3">
                Lorem ipsum dolor, sit amet consectetur adipisicing elit.
                Recusandae, pariatur voluptatem numquam soluta nemo ratione
          ...
          <div class="card">
            <div class="flex items-center justify-between p-4">
              ...
              <div id="cardMenu5" class="inline-flex">
                <button
                  class="popper-ref btn -mr-1.5 h-8 w-8 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25"
                >
                  <svg
