<template>
  ...
  <div class="h-100vh mt-0 flex w-full flex-col">
    <!-- Chat header -->
    <div
      class="chat-header z-10 flex h-[61px] w-full shrink-0 items-center justify-between border-b border-slate-150 bg-white shadow-sm transition-[padding,width] duration-[.25s] dark:border-navy-700 dark:bg-navy-800"
    >
          ...
          <div class="flex flex-col items-start space-y-3.5">
            <div class="mr-4 max-w-lg sm:mr-10">
              <div
                class="rounded-2xl rounded-tl-none bg-white p-3 text-slate-700 shadow-sm dark:bg-navy-700 dark:text-navy-100"
              >
                Recusabo mandamus cum ex, ius unum nibh an, usu liber oratio liberavisse
                ea.
              </div>
              <p
                class="mt-1 ml-auto text-right text-xs text-slate-400 dark:text-navy-300"
    ...
    <!-- chat-footer  -->
    <div
      class="chat-footer flex h-12 w-full shrink-0 items-center justify-between border-t border-slate-150 bg-white px-[calc(var(--margin-x)-.25rem)] transition-[padding,width] duration-[.25s] dark:border-navy-600 dark:bg-navy-800"
    >
      <div class="-ml-1.5 flex flex-1 space-x-2">
        <button
          class="h-9 w-9 shrink-0 rounded-full p-0 text-slate-500 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:text-navy-200 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            class="h-5.5 w-5.5"
        ...
        <input
          type="text"
          class="appearance-none border-none placeholder:font-light focus:outline-none focus:ring-0 h-9 w-full rounded-md bg-transparent placeholder:text-slate-400/70"
      ...
      <div class="-mr-1.5 flex">
        ...
        <button
          class="h-9 w-9 shrink-0 rounded-full p-0 text-primary hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:text-accent-light dark:hover:bg-accent-light/20 dark:focus:bg-accent-light/20 dark:active:bg-accent-light/25"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            class="h-5.5 w-5.5"
