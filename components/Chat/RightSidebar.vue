      ...
      >
        <div class="flex items-center justify-between py-2 px-4">
          <p
            ...
            class="right-sidebar-header flex waitshrink-0 items-center space-x-1.5"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              class="h-4 w-4"
        ...
        >
          ...
          <div class="mt-3">
            ...
            <div class="scrollbar-sm mt-3 flex space-x-4 overflow-x-auto px-3">
              <div
                class="relative flex h-28 w-48 waitshrink-0 flex-col overflow-hidden rounded-xl bg-gradient-to-br from-purple-500 to-indigo-600 p-3"
              >
                <div class="grow">
                  <img
                    class="h-3"
              ...
              <div
                class="relative flex h-28 w-48 waitshrink-0 flex-col overflow-hidden rounded-xl bg-gradient-to-br from-pink-500 to-rose-500 p-3"
              >
                <div class="grow">
                  <img
                    class="h-3"
              ...
              <div
                class="relative flex h-28 w-48 waitshrink-0 flex-col overflow-hidden rounded-xl bg-gradient-to-br from-info to-info-focus p-3"
              >
                <div class="grow">
                  <img
                    class="h-3"
