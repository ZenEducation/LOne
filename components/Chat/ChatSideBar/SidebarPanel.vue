...
import sidebarChatComponent from './sidebarChatComponent.vue';
import sidebarFooterComponent from './sidebarFooterComponent.vue';
import sidebarHistoryComponent from './sidebarHistoryComponent'
