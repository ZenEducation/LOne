      ...
      <div class="card px-4 pb-4 sm:px-5">
        ...
        <div class="max-w-2xl">
          <p>
            ...
            loaded to reduce load-time frustration. Check out code for detail of
            usage.
          </p>
      ...
      <div class="card px-4 pb-4 sm:px-5">
        ...
        <div class="max-w-2xl">
          <p>
            ...
            <code class="inline-code">animate-pulse</code> to fade in and out
            skeleton. Check out code for detail of usage.
          </p>
          <div class="mt-5 max-w-md">
            <div
              class="
