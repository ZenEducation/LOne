<template>
  <div>
    <div>
          ...
          <label class="relative hidden w-full max-w-[16rem] sm:flex">
            <input
              class="
                ...
                hover:z-10 hover:border-slate-400
                focus:z-10 focus:border-primary
                        ...
                        <div class="mt-2 flex flex-wrap space-x-1">
                          ...
                          <div
                            class="
                              ...
                              px-1.5
                              text-secondary
                              dark:bg-secondary/15 dark:text-secondary-light
                            "
                          >
                            Performance
                          </div>
                            ...
                            <div class="avatar h-5 w-5 hover:z-10">
                              <div
                                class="
                                  ...
                                  text-white
                                  ring-1 ring-white
                                  dark:bg-secondary-light dark:ring-navy-700
                                "
                              >
                                jd
                              </div>
      ...
      <KanbanSidebar v-show="kanbanedit" @close="kanbanedit = false" />
    </div>
...
import KanbanSidebar from "@/components/Apps/Kanban-sidebar.vue";

const elements = computed(() => {
  return [{ id: 1, name: "One" }];
});

const kanbanedit = ref(false);
</script>
