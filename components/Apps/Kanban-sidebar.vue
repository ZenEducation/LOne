<template>
  <div id="kanban-setting-drawer" class="drawer drawer-right">
    ...
    <div
      class="drawer-content fixed right-0 top-0 z-[101] h-full w-full sm:w-80"
    >
              ...
              >
                ...
                <div class="-mr-1.5 flex">
                  ...
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      class="ac-icon h-3.5 w-3.5 transition-transform"
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                    >
                  ...
                  <li>
                    <a
                      class="
                        ...
                        focus:text-navy-800
                        dark:hover:text-navy-100 dark:focus:text-navy-100
                      "
                      href="#"
                    >
                      <svg
                  ...
                  <li class="timeline-item">
                    <div
                      class="
                        ...
                        bg-white
                        text-secondary
                        dark:bg-navy-700 dark:text-secondary-light
                      "
                    >
                  ...
                  <li class="timeline-item">
                    <div
                      class="
                        ...
                        bg-white
                        text-primary
                        dark:bg-navy-700 dark:text-accent
                      "
                    >
                    ...
                    <div class="timeline-item-content flex-1 pl-4">
                      ...
                      <a
                        ...
                        class="
                          ...
                          transition-colors
                          hover:text-primary
                          dark:text-navy-100 dark:hover:text-accent
                        "
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
