  ...
  <div class="main-content w-full px-[var(--margin-x)] pb-8">
        ...
        <div class="grid grid-cols-12 gap-4 sm:gap-5 lg:gap-6">
          <div class="col-span-12 lg:col-span-8">
            <div
              class="flex items-center justify-between space-x-3 sm:space-x-5"
            >
            ...
            >
              <div class="card">
                ...
                />
                <div
                  class="absolute inset-0 flex h-full w-full flex-col justify-between"
                >
                  ...
                  >
                    <div>
                      <a
                        href="#"
                        class="text-base font-semibold text-white line-clamp-2"
                      >
                        South Island
                      </a>
                    </div>
                    <div
                      class="mt-1 flex items-center space-x-3 text-slate-200"
                    >
          ...
          <div class="col-span-12 lg:col-span-4">
            <div class="card px-4 pb-5 sm:px-5">
              <div class="flex items-center justify-between py-3">
                ...
                <div id="top-hotels-menu" class="inline-flex">
                  <button
              ...
              <div class="space-y-4">
                <div class="flex items-center justify-between space-x-2">
                  <div class="flex items-center space-x-4">
                    <img
                      class="mask is-squircle h-12 w-12 object-cover object-center"
                    ...
                    <div class="space-y-1">
                      ...
                      <div class="flex items-center space-x-3 text-xs">
                        <p class="flex items-center space-x-1">
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            class="h-3.5 w-3.5 text-slate-400 dark:text-navy-300"
                            fill="none"
                            viewBox="0 0 24 24"
                            stroke="currentColor"
                          >
            ...
            <div class="mt-4 sm:mt-5">
              <div class="flex items-center justify-between">
                ...
                <div id="my-plan-menu" class="inline-flex">
                  <button
              ...
              <div class="mt-3 space-y-4">
                <div class="card p-2">
                  <div class="flex space-x-4">
                    <img
                      class="h-18 w-18 rounded-lg object-cover object-center"
                      src="images/600x400.png"
                      alt="image"
                    />
                    <div>
                      <a
                        href="#"
                        class="font-medium text-slate-700 outline-none transition-colors hover:text-primary focus:text-primary dark:text-navy-100 dark:hover:text-accent-light dark:focus:text-accent-light"
                        >Picnic on forest</a
                      >
